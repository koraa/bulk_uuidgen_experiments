...
public:
  ...
  __attribute__((flatten)) const uuid_t& operator()() {
...
__attribute__((flatten)) void write_uuid(const uuid_t &uu, Buf &buf, size_t &off) {
...
__attribute__((flatten)) extern "C" int main() {
